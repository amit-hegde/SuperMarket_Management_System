    ...
    <div id="mySidenav" class="sidenav">
        <div class="btn-group">
           <form action=" " method="POST" >
            ...
            <button type="submit" formaction="sbillreport">Billing report</button>
            <button type="submit" formaction="locator">Product Locator</button>
            <button type="submit" formaction="index">Logout</button>
            </form>
        </div>
...
<body>
 ...
 <script type="text/javascript">	
  ...
  @cherrypy.expose() 
  def billreport(self,billid=None,fd=None,td=None):
...
<body>
    ...
    <div class="div3">
        <lable>Bill No.</lable><input type="text" name="billid" id="billid" placeholder="Enter Bill Number">
        <button type="submit" class="button10">search</button>
        <label for="fb">From date:</label>
        <input type="date" id="from" name="from">
        <label for="tb">To date:</label>
        <input type="date" id="from" name="from">
  ...
  @cherrypy.expose() 
  def sbillreport(self,billid=None,fd=None,td=None):
...
<body>
    ...
    <div class="div">
        <form method="post" action="addpatient">
            <div class="div1">
                <label for="itid">Item ID</label>
                <input type="text" id="sid" name="sid" placeholder="Enter item id">
                ...
                <input type="text" id="mname" name="Mname" placeholder="Brand Name">

                </select>
            </div>
            <div class="div2">
                <label for="stock">MRP</label>
                <input type="text" id="stock" name="stock" placeholder="MRP">

                <label for="tsale">Discount</label>
                <input type="text" id="tsale" name="TotalSale" placeholder="Discount">

                <label for="nstock">Our Price</label>
                <input type="text" id="nstock" name="nstock" placeholder="Selling Price">
                </select>
